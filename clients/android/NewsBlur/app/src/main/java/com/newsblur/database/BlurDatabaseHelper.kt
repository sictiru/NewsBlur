...
class BlurDatabaseHelper private constructor(
    ...
    private suspend fun clearInfrequentSession() = withContext(Dispatchers.IO) {
        val values = ContentValues()
    ...
    @WorkerThread
    fun clearInfrequentSessionBlocking() = runBlocking {
        clearInfrequentSession()
    }
}